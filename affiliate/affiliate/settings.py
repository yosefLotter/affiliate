...
BLEACH_ALLOWED_TAGS = ['p', 'b', 'i', 'u', 'em', 'h4', 'a', 'ul', 'li', 'hr', 'table', 'tr', 'th', 'td', 'br', 'meta', 'h1', 'h3', 'h4', 'span',]
BLEACH_ALLOWED_ATTRIBUTES = ['href', 'title', 'style', 'class', 'name', 'content', 'iframe', 'frameborder', 'src']
